...
def plot_trace_amplitude_only(
    ...
    plt.xlim(3500, 3900)
    plt.xticks(np.arange(3500,3900,100))
    plt.xlabel("Time (ms)")
...
if __name__ == "__main__":
    clean_path = "data/real/clean_norm.npy"
    noisy_path = "data/real/noisy_norm.npy"
    bm3d_path  = 'data/real/bm3d_denoised_norm.npy'
    ksvd_path  ='data/real/ksvd_denoised_norm.npy'
    dncnn_path = 'data/real/dncnn_denoised_norm.npy'
    dcdicl_path = 'data/real/dcdicl_denoised_norm.npy'
    ...
    plot_trace_amplitude_only(
        ...
        trace_idx=12,                 # 改成你想看的道号
        dt_ms=1,                      # 如果知道采样间隔，比如 0.002 或 0.006，就填进去
        save_path="fig_check/real_data_look/single_channel/2trace_50_dcdicl.png"
    )