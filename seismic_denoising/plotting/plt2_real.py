...
# ========= clean =========
npy_path = 'data/real/clean_norm.npy'   # 改成你的npy文件路径
...
section = data[:50,:].T
patch1 = section[3600:5600, 12:38]


#=============直接读取noisy==================
npy_path2 = 'data/real/noisy_norm.npy'
data = np.load(npy_path2)
section = data[:50,:].T
patch2 = section[3600:5600, 12:38]

#=============dncnn==========================
npy_path3 = 'data/real/dncnn_denoised_norm.npy'
data = np.load(npy_path3)
section = data[:50,:].T
patch3 = section[3600:5600, 12:38]



#=============ksvd==========================
npy_path4 = 'data/real/ksvd_denoised_norm.npy'
data = np.load(npy_path4)
section = data[:50,:].T
patch4 = section[3600:5600, 12:38]


#=============bm3d==========================
npy_path5 = 'data/real/bm3d_denoised_norm.npy'
data = np.load(npy_path5)
section = data[:50,:].T
patch5 = section[3600:5600, 12:38]


#===============dcdicl===================
npy_path6 = 'data/real/dcdicl_denoised_norm.npy'
data = np.load(npy_path6)
section = data[:50,:].T
patch6 = section[3600:5600, 12:38]
